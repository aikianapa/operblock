<div data-role="page" data-theme="a" id="mainsisterList" data-url="/mainsister/list/list.htm?null=&person_id={{person_id}}" data-ajax="false">
...
<a href="/reports/list/list.htm?null=&person_id={{person_id}}" data-ajax="false" data-mini="true" class="ui-btn">Перейти к отчётам</a>
...
=========================================== -->
<div id="mainsisterNazn" data-theme="a" data-role="page"  data-ajax="true" >
...
<!-- ======================================== -->
<script type="text/javascript" src="/forms/mainsister_list.js"></script>
