...
<br />
<h2 style="font-size:14pt;">ВЫПИСНОЙ ЭПИКРИЗ <div style="font-size:10px;">от {{s_date2}}</div></h2>
</p>

<ul class="fields">
		<li><b>Фамилия, Имя, Отчество:</b> {{client}}, <b>возраст</b> {{age}} лет    И/Б {{event_id}}</li>
		...
		<ul>
			...
			<li><b>Аллергологический анамнез:</b><textarea name="e_an_vitae" from="firstView@Аллергологический анамнез">{{e_al_anamnez}}</textarea> </li>
			<li>
		...
		<h2>Течене заболевания в отделении</h2>
		<ul></ul>
		<h2>Состояние при переводе</h2>
